...
import { NOTIFICATION_TYPES } from '@/services/notifications/notifications.constants'
...
function refreshNotificationSubscriptions(userId, options = {}) {
  invalidatePollingSubscriptions(
    [
      getNotificationsListSubscriptionKey(userId, options),
      getUnreadCountSubscriptionKey(userId),
    ],
    { refetch: true }
  )
}
