import { normalizeLowerValue } from '@/shared';
import {
...
export function validateAllowedEmailDomain(value) {
  ...
  if (!isAllowed) {
    throw new Error(
      'Only supported email domains are allowed: Gmail, Outlook, Hotmail, Live, Yandex, Yahoo, Proton Mail, iCloud, Mail.ru, GMX, Zoho',
    );
  }
