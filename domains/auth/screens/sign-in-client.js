...
import { AUTH_PURPOSE, AUTH_ROUTES } from '@/domains/auth/constants';
import {
  buildAuthHref,
  createError,
  isEmailIdentifier,
...
import Registry from '@/domains/auth/screens/sign-in-registry';
import ForgotPasswordAction from '@/domains/auth/forgot-password-action';
import {
  INITIAL_RESET_FLOW,
  consumeAuthRouteNoticeCookie,
  resolveSignInNoticeToast,
} from '@/domains/auth/screens/sign-in-state';
import View from '@/domains/auth/screens/sign-in-page';
...
export default function Client() {
  ...
  const registry = (
    <Registry authIsReady={auth.isReady} isResetMode={isResetMode} action={forgotPasswordAction} />
  );
