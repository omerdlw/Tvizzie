    ...
    <>
      ...
      <LegalPageShell>
        <div className={LEGAL_PAGE_CONTENT_CLASS}>
          ...
          <LegalQuickLinks activePath="/privacy" />
            ...
            <LegalDocument>
              <LegalSection title="Overview">
                <p>
                  ...
                  other public content. We only try to collect the information needed to operate
                  those features, secure accounts, and improve reliability.
                </p>
                <p>
                  If you have privacy questions, you can contact{' '}
                  <a
                    className="underline decoration-white/15 underline-offset-4 transition-all duration-300 ease-in-out hover:text-white"
              ...
              <LegalSection title="How we use information">
                <ul className="list-disc space-y-2 pl-5">
                  ...
                  <li>
                    ...
                    sign-in and account-change verification codes.
                  </li>
                  <li>
              ...
              <LegalSection title="When information is visible to other people">
                <p>
                  ...
                  name, avatar, biography, watched titles, watchlist, favorites, lists, reviews,
                  likes, and activity history, depending on the feature.
                </p>
                <p>
                  If you switch your profile to private, the app restricts access to profile
              ...
              <LegalSection title="Cookies and local storage">
                <p>
                  ...
                  storage is necessary for the app to function, including authentication cookies and
              ...
              <LegalSection title="Retention">
                <p>
                  ...
                  choose to keep in your account. If you delete content, it may disappear from
                  active views before it disappears from backups or logs. If you delete your
                  account, we aim to remove or deactivate associated account data within the normal
              ...
              <LegalSection title="Your choices">
                <ul className="list-disc space-y-2 pl-5">
                  ...
                  <li>
                    You can stop using any connected OAuth sign-in methods from account security.
                  </li>
                </ul>
              </LegalSection>
