...
function FollowActionButton({ action, isLoading = false, onClick }) {
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      whileTap={isLoading ? undefined : { scale: NAV_TAP_SCALE }}
      ...
      <div className="flex w-full items-center gap-2.5">
        {!isPreviousMonthHidden ? (
          <Button
            ...
            className="center h-[38px] w-[38px] shrink-0 rounded-[20px] ring-1 ring-inset ring-white/5 bg-white/5 text-white/70 transition-colors hover:bg-white/10 hover:text-white focus-visible:ring-2 focus-visible:ring-white/40 focus-visible:ring-inset active:scale-[0.96]"
          >
