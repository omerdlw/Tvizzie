...
/**
 * SeriesGraph can occasionally return a partially populated season. Merge its
 * IMDb data with the already-requested TMDB season details so the ratings grid
 * retains the full episode structure instead of silently dropping episodes.
 */
