import { assertTitleMedia, buildMediaItemKey } from './media-key.js';
import { normalizeTimestamp, normalizeLowerValue } from '@/domains/shell/shared/utils.js';
import {
  isTitleMediaType,
...
export function createMediaPayload(media = {}, userId = null, options = {}) {
  ...
  return {
    ...
    watchProviders:
      media.watchProviders && typeof media.watchProviders === 'object'
