...
function View({
  ...
  return (
    <>
      ...
      >
        <div className="relative flex w-full flex-col items-start gap-8 pt-6 sm:pt-8 lg:flex-row lg:items-start lg:gap-10 lg:pt-10 xl:gap-12">
          <div className="order-1 w-full shrink-0 lg:sticky lg:top-6 lg:w-80 xl:w-96">
            <Sidebar
              item={movie}
          ...
          <div className="order-2 flex w-full min-w-0 flex-col lg:flex-1">
            <div className="relative mb-6 flex w-full flex-col sm:mb-8">
