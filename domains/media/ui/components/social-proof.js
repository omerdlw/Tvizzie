...
export default function MediaSocialProof({ media, viewerId }) {
  ...
  return (
    <button
      ...
      className="group inline-flex items-center gap-1.5 rounded-full border border-black/10 bg-black/5 px-3 py-1.5 text-[11px] font-semibold tracking-wider text-black/70 uppercase hover:border-black/20 hover:bg-black/10 hover:text-black"
    >
      <Icon
