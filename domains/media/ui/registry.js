...
import WatchProvidersSurface, {
  createWatchProvidersSurfaceEntry,
} from '@/domains/shell/navigation/surfaces/watch-providers-surface';
  ...
  usePageRegistry({
    nav: {
      ...
      icon:
        ...
        (movie?.poster_path ? `${TMDB_IMG}/w342${movie.poster_path}` : undefined),
