...
export default function MediaReviews({
  ...
  const {
    ...
    entityId,
    entityType,
    // The detail page only renders a recent preview; loading the full 120
    // review feed here was causing multi-second requests and repeated dev
    // route rendering. The dedicated reviews page can still load the full
    // collection.
