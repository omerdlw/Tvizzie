/**
 * @file features/account/motion.js
 * @description Account route için sinematik animasyon tanımları.
 *
 * Koreografi:
 *   1. Hero (banner + avatar + isim)   → soldan kayarak giriş + blur çözme
 *   2. Nav bar                          → üstten düşme + blur çözme
 *   3. İçerik bölümleri                → sıralı (stagger) aşağıdan yukarı giriş
 *   4. Kart grid'leri                  → kademeli (stagger) fade + scale + blur
 *   5. Scroll-triggered bölümler       → whileInView ile tetikleme
 */
...
// ─── 6. HERO ANIMASYONLARI ────────────────────────────────────────────────────

/**
 * Hero banner: Tam genişlik arka plan görseli, blur çözerek beliriyor
 */
...
/**
 * Hero overlay'leri (tint, soften, fade katmanları)
 */
...
/**
 * Hero avatar: Aşağıdan yukarı scale + blur çözme
 */
...
/**
 * Hero kullanıcı adı / display name
 */
...
/**
 * Hero istatistik sayaçları: Tek tek kademeli giriş
 */
...
/**
 * Hero biyografi / description metni
 */
...
/**
 * Profil sekmeleri nav bar: Üstten aşağı düşme
 */
...
/**
 * Nav sekme öğeleri: Sıralı kademeli giriş
 */
...
// ─── 8. ANA SAYFA SHELL (PAGE CONTAINER) ─────────────────────────────────────

/**
 * Tüm sayfa içeriğini kapsayan wrapper
 */
...
// ─── 9. BÖLÜM ANIMASYONLARI ───────────────────────────────────────────────────

/**
 * Her overview / feed bölümü (Favorites, Watched, Watchlist, vb.)
 * Scroll tetiklemeli, görünüme girince canlanıyor.
 */
...
// ─── 10. KART ANIMASYONLARI ───────────────────────────────────────────────────

/**
 * Media/poster kartları — grid içinde sıralı kademeli giriş
 */
...
/**
 * Review / list kartları — yatay düzende sıralı giriş
 */
...
/**
 * Activity akış öğeleri — soldan kademeli giriş
 */
...
/**
 * Account Edit sayfası form alanları
 */
