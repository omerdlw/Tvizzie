...
function useActivityClientState({ auth, routeData, sectionProviderValue, sectionState }) {
  ...
  const { canViewPrivateContent, isOwner, isPrivateProfile, isViewerReady, resolvedUserId } =
    sectionState;
...
const ActivityView = createAccountSectionView({
...
const AccountActivityView = createAccountSectionClient({
  activeTab: 'activity',
