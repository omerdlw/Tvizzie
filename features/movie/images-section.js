...
const TABS = Object.freeze([
  {
    ...
    label: 'Backdrops',
    aspect: 'aspect-video',
    width: 'w-[min(18rem,calc(100vw-4.5rem))] sm:min-w-[18rem] sm:w-[calc((100%-1.5rem)/3)] md:w-[calc((100%-2.25rem)/4)]',
    size: 'w780',
    sizes: '288px',
  },
  {
  ...
  },
  {
    ...
    label: 'Logos',
    aspect: 'aspect-video',
    width: 'w-[min(13rem,calc(100vw-5rem))] sm:min-w-[13rem] sm:w-[calc((100%-1.5rem)/3)]',
    size: 'w500',
    sizes: '208px',
  },
]);
