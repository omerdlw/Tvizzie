...
export const PAGE_GRADIENT_BACKDROP_CLASS =
  'pointer-events-none absolute inset-0 z-0 bg-[linear-gradient(to_bottom,rgba(0,0,0,0.06)_0%,rgba(0,0,0,0.14)_20vh,rgba(0,0,0,0.38)_42vh,rgba(0,0,0,0.78)_58vh,#000_70vh,#000_100%)]'
