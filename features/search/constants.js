...
export const SEARCH_STYLES = Object.freeze({
  ...
  input: 'flex w-full  text-sm items-center p-2 pl-4 transition-colors duration-[200ms]',
  tabButton:
    'relative  shrink-0 px-3 py-1.5 text-xs whitespace-nowrap w-full flex-auto transition-colors',
  tabList: 'hide-scrollbar -mx-1 flex items-center gap-2 overflow-x-auto px-1',
  resultItem: 'group flex  cursor-pointer items-center justify-between transition-all p-1 duration-[200ms] hover:bg-primary/70',
