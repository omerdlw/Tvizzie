...
export default function AccountEditorModal({ close, data, header }) {
  ...
  return (
    <Container className="w-full sm:w-xl" header={{ ...header }} close={close}>
      <form onSubmit={handleSubmit} className="flex w-full flex-col gap-3 p-2">
        <div className="grid gap-5 p-2 md:grid-cols-2">
          <div className="space-y-2">
            <label className={`ml-1 text-[10px] font-bold tracking-widest text-[#1d4ed8] uppercase`}>
              Display Name
            </label>
            <Input
              ...
              className={{
                input: `w-full border border-[#0ea5e9] bg-[#bae6fd] px-4 py-3 text-sm font-medium text-[#0c4a6e] transition-colors outline-none placeholder:text-[#0369a1]`,
              }}
            />
          </div>
          <div className="space-y-2">
            <label className={`ml-1 text-[10px] font-bold tracking-widest text-[#1d4ed8] uppercase`}>Username</label>
            <Input
              value={form.username}
          ...
          <div className="space-y-2">
            <label className={`ml-1 text-[10px] font-bold tracking-widest text-[#1d4ed8] uppercase`}>Avatar URL</label>
            <Input
          ...
          <div className="space-y-2">
            <label className={`ml-1 text-[10px] font-bold tracking-widest text-[#1d4ed8] uppercase`}>Banner URL</label>
            <Input
        ...
        <div className="space-y-2 p-2">
          <Textarea
            ...
            maxHeight={120}
            className={{
              textarea: `min-h-[150px] w-full resize-none border border-[#0ea5e9] bg-[#bae6fd] px-4 py-3 text-sm text-[#0c4a6e] transition-colors outline-none placeholder:text-[#0369a1]`,
            }}
          />
        </div>
