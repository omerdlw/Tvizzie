...
const UI = {
  ...
  trigger:
    'inline-flex w-auto flex-auto h-9 shrink-0 items-center gap-1.5 rounded-xl border border-black/10 bg-white px-3 text-[11px] font-semibold uppercase tracking-wide text-black/70 transition-colors hover:border-black/20 hover:bg-black/5',
  triggerActive: 'border-info/70 bg-info/20 text-info',
  iconButton:
    'inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-black/10 bg-white text-black/70 transition-colors hover:border-black/20 hover:bg-black/5',
  resetButton:
    'ml-auto inline-flex h-9 shrink-0 items-center rounded-xl border border-black/10 bg-white px-3 text-[11px] font-semibold uppercase tracking-wide text-black/70 transition-colors hover:border-black/20 hover:bg-black/5',
  ...
  menuItem:
    'flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-sm text-black/80 transition-colors hover:bg-black/5',
  menuItemActive: 'bg-black/5 font-medium text-black',
  divider: 'border-t border-black/10',
  inputWrap:
    'flex h-9 min-w-0 flex-1 items-center gap-3 rounded-xl border border-black/10 bg-white px-3 transition-colors focus-within:border-black/20',
  input: 'min-w-0 flex-1 bg-transparent text-sm text-black outline-none placeholder:text-black/50',
  select:
    'h-8 w-full rounded-lg border border-black/10 bg-white px-2 text-sm text-black outline-none transition-colors focus:border-black/20',
  helperText: 'px-1 text-[10px] text-black/50',
  visibilityItem:
    'flex w-full items-center justify-between rounded-lg px-3 py-2 text-left text-sm text-black/80 transition-colors hover:bg-black/5',
  visibilityItemActive: 'bg-black/5 font-medium text-black',
  dot: 'h-2.5 w-2.5 rounded-full border border-black/20',
  dotActive: 'bg-black',
