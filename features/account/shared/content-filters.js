...
const UI = {
  bar: 'flex w-full flex-nowrap flex-auto items-center gap-2 overflow-x-auto border-b border-white/10 pb-5 scrollbar-none',
  trigger:
    'inline-flex h-9 w-auto flex-auto shrink-0 items-center gap-1.5 rounded border border-white/10 bg-black px-3 text-[11px] font-semibold uppercase tracking-wide text-white/70 transition-colors hover:border-white/20 hover:bg-white/10',
  triggerActive: 'border-info/70 bg-info/20 text-info',
  iconButton:
    'inline-flex h-9 w-9 shrink-0 items-center justify-center rounded-xs border border-white/10 bg-black text-white/70 transition-colors hover:border-white/20 hover:bg-white/10',
  resetButton:
    'ml-auto inline-flex h-9 shrink-0 items-center rounded border border-white/10 bg-black px-3 text-[11px] font-semibold uppercase tracking-wide text-white/70 transition-colors hover:border-white/20 hover:bg-white/10',
  menu: 'z-50 overflow-y-auto overscroll-contain rounded border border-white/10 bg-black p-1 shadow-lg',
  sectionLabel: 'px-2 py-1.5 text-[10px] font-semibold uppercase tracking-wide text-white/50',
  menuItem:
    'flex w-full items-center justify-between rounded-xs px-3 py-2 text-left text-sm text-white/80 transition-colors hover:bg-white/10',
  menuItemActive: 'bg-white/10 font-medium text-white',
  divider: 'border-t border-white/10',
  inputWrap:
    'flex h-9 min-w-0 flex-1 items-center gap-3 rounded border border-white/10 bg-black px-3 transition-colors focus-within:border-white/20',
  input: 'min-w-0 flex-1 bg-transparent text-sm text-white outline-none placeholder:text-white/50',
  select:
    'h-8 w-full rounded-xs border border-white/10 bg-black px-2 text-sm text-white outline-none transition-colors focus:border-white/20',
  helperText: 'px-1 text-[10px] text-white/50',
  visibilityItem:
    'flex w-full items-center justify-between rounded-xs px-3 py-2 text-left text-sm text-white/80 transition-colors hover:bg-white/10',
  visibilityItemActive: 'bg-white/10 font-medium text-white',
  dot: 'h-2.5 w-2.5 rounded-xs border border-white/20',
  dotActive: 'bg-white',
  ...
  return (
    <div className={cn(UI.divider, 'mt-1 space-y-2 px-2 pt-3')}>
      <div className="space-y-1">
        ...
        <div className="rounded-xs border border-white/10 bg-black px-2 py-2">
