...
function PreviewPoster({ index, isHovered, item, total }) {
  ...
  return (
    ...
    >
      <div
        className="overflow-hidden border border-[#0ea5e9]"
        style={{
      ...
      >
        {imageSrc ? (
          ...
          <div className="center h-full w-full bg-[#dbeafe] text-[#94a3b8]">
...
function PlaceholderPoster({ index, isHovered, total }) {
  ...
  return (
    ...
    >
      <div
        className="border border-dashed border-[#0ea5e9]"
        style={{
          height: `${POSTER_HEIGHT}px`,
          width: `${POSTER_WIDTH}px`,
        }}
  ...
  return (
    ...
    >
      <Link href={getListHref(list)} className="block">
        ...
        >
          <motion.div
            className="relative z-0 border border-[#0284c7] bg-[#dbeafe]"
            initial={false}
            animate={{
          ...
          <motion.div
            className="absolute right-0 bottom-0 left-0 z-10 overflow-hidden rounded-2xl border border-[#0284c7] bg-[#dbeafe]"
            initial={false}
            animate={{
          ...
          >
            <div className="relative min-h-[92px] px-4 py-4">
              <h3 className="line-clamp-2 min-h-[2.75rem] text-[18px] leading-[1.22] font-semibold text-[#0f172a]">
                {list?.title || 'Untitled List'}
              </h3>
            </div>

            <div className="relative h-12 border-t border-[#0ea5e9]">
              <div className="absolute inset-0 flex items-center justify-between px-2 text-[14px] text-[#64748b]">
