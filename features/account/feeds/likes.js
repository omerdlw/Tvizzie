...
} from '@/features/account/filters/content-filter-primitives';
import AccountInlineSectionState from '@/features/account/components/section-state';
import AccountSectionLayout, {
  AccountSectionState,
} from '@/features/account/components/section-wrapper';
import AccountMediaGridPage, {
  ProfileMediaActions,
} from '@/features/account/components/media-grid';
...
function ReorderableListItem({
  ...
  return (
    <div className="relative w-full">
      <div className="flex w-full items-center gap-2 rounded-xl border border-black/15 bg-white/40 px-4 py-3">
        ...
        <div className="flex shrink-0 items-center gap-1">
          <Button
            className="center size-8 rounded-xl border border-black/10 bg-white text-black/70 disabled:opacity-50"
