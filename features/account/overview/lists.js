                      ...
                      <div className="flex items-center gap-1.5">
                        ...
                        {typeof onDeleteList === 'function' ? (
                          <button
                            ...
                            className="bg-primary/30 hover:bg-error hover:border-error flex size-8 items-center justify-center border border-black/10 text-black/70 transition-colors hover:text-white"
                          >
