...
export default function AccountPagination({
  ...
  const config = { canUseLinks: typeof getPageHref === 'function', canUseButtons: typeof onPageChange === 'function' };
...
function PaginationNavButton({
  ...
  return (
    <span aria-hidden="true" className={cn(resolvedClass, disabled && 'cursor-not-allowed opacity-40')}>
      {navContent}
    </span>
  );
}
