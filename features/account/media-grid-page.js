            ...
            <div className="flex flex-wrap items-center justify-end gap-2">
              {activePage > 1 ? (
                <Link
                  ...
                  className="center size-12 border border-white/5  text-xs font-semibold text-white transition hover: hover:text-white"
                >
                ...
                typeof item === 'number' ? (
                  <Link
                    ...
                    className={cn(
                      ...
                      item === activePage
                        ? ' text-white'
                        : 'border-white/5  text-white hover: hover:text-white'
                    )}
                  >
                    {item}
                  </Link>
