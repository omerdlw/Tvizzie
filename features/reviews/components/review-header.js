...
const REVIEW_HEADER_BADGE_CLASS =
  'bg-white/5 hover:bg-white/10 backdrop-blur inline-flex h-10 min-w-28 items-center justify-center gap-1.5 border border-white/5 px-4 text-xs font-semibold text-white/70 uppercase tabular-nums';
