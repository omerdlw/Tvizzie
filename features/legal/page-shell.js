    ...
    <PageGradientShell className="overflow-hidden">
      ...
      >
        <header className="max-w-3xl space-y-4">
          <p className="text-[11px] font-semibold tracking-[0.22em] text-black/48 uppercase">
            Legal
          </p>
          <div className="space-y-3">
            ...
            <p className="max-w-2xl text-sm leading-7 text-black/68 sm:text-[15px]">
              {description}
            </p>
          </div>
        ...
        <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_18rem] lg:items-start">
          ...
          <aside className="p-5 text-sm leading-7 text-black/70">
            ...
            <div className="mt-3 flex flex-col gap-2">
              ...
              <a className="hover:text-black" href="mailto:tvizzie.app@gmail.com">
