...
export const PROVIDER_BUTTON_CLASSNAMES = Object.freeze({
  default: "inline-flex w-full items-center gap-3 justify-center h-13 px-4 text-black hover:bg-black hover:text-white border border-black/10 disabled:cursor-not-allowed disabled:opacity-60"
});
export default function OAuthProviderButton({
  ...
  return <Button type="button" onClick={onClick} disabled={disabled || isBusy} aria-label={`${actionLabel} ${providerLabel}`} classNames={PROVIDER_BUTTON_CLASSNAMES}>
