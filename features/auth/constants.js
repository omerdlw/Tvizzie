...
export const AUTH_ERROR_MESSAGES = Object.freeze({
  ...
  GOOGLE_LINK_EMAIL_MISMATCH:
    'Google account email must match your current email to link',
...
export const AUTH_ERROR_MESSAGE_PATTERNS = Object.freeze([
  ...
  [
    ...
    AUTH_ERROR_MESSAGES.INVALID_LOGIN_CREDENTIALS,
  ],
  ...
  [
    'GOOGLE_EMAIL_UNAVAILABLE',
    AUTH_ERROR_MESSAGES.GOOGLE_EMAIL_UNAVAILABLE,
  ],
  [
    'GOOGLE_PASSWORD_LOGIN_REQUIRED',
    AUTH_ERROR_MESSAGES.GOOGLE_PASSWORD_LOGIN_REQUIRED,
  ],
  ['GOOGLE_SIGNUP_REQUIRED', AUTH_ERROR_MESSAGES.GOOGLE_SIGNUP_REQUIRED],
  [
    'GOOGLE_PROVIDER_COLLISION',
    AUTH_ERROR_MESSAGES.GOOGLE_PROVIDER_COLLISION,
  ],
  [
    'GOOGLE_LINK_EMAIL_MISMATCH',
    AUTH_ERROR_MESSAGES.GOOGLE_LINK_EMAIL_MISMATCH,
  ],
  [
    'GOOGLE_UNLINK_REQUIRES_PASSWORD',
    AUTH_ERROR_MESSAGES.GOOGLE_UNLINK_REQUIRES_PASSWORD,
  ],
])
