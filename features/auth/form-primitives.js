...
export const AUTH_PRIMARY_BUTTON_CLASSNAMES = Object.freeze({
  default:
    'inline-flex h-12 w-full items-center justify-center border border-transparent bg-black px-4 font-semibold text-white hover:border-black/10 hover:bg-black/90 disabled:cursor-not-allowed disabled:opacity-60',
});
export const AUTH_SECONDARY_BUTTON_CLASSNAMES = Object.freeze({
  default:
    'inline-flex h-12 w-full items-center justify-center border border-black/10 bg-primary px-4 text-black hover:bg-white disabled:cursor-not-allowed disabled:opacity-60',
});
