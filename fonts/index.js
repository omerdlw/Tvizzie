...
export const zuume = localFont({
    ...
    src: [
        ...
        { path: './zuume/Zuume-ExtraLightItalic.woff2', weight: '200', style: 'italic' },
        ...
        { path: './zuume/Zuume-MediumItalic.woff2', weight: '500', style: 'italic' },
        { path: './zuume/Zuume-SemiBold.woff2', weight: '600', style: 'normal' },
        { path: './zuume/Zuume-SemiBoldItalic.woff2', weight: '600', style: 'italic' },
        ...
        { path: './zuume/Zuume-ExtraBoldItalic.woff2', weight: '800', style: 'italic' },
