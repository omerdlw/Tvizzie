...
import { useAuth, useAuthSessionReady } from '../auth';

import { createAccountClient } from './adapter';

// Account provider defaults and lifecycle policy.
...
// Provider owns current-account bootstrap, loading, subscription and actions.
...
// Context selectors and the aggregate Account facade.
