...
/**
 * Determines whether a value can be rendered in a navigation field.
 * @param {*} value - Candidate renderable value
 * @returns {boolean} Whether the value is renderable
 */
export function isRenderableNavValue(value) {
...
/**
 * Validates a navigation registry configuration and reports every contract violation.
 * @param {object} config - Candidate navigation configuration
