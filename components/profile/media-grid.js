        ...
        >
            <div className="relative h-full w-full">
                ...
                <div 
                    ...
                    className="absolute top-2 left-2 z-20 flex size-9 cursor-grab items-center justify-center rounded-xl bg-black/60 text-white shadow-lg backdrop-blur-md transition-all hover:bg-black/80 active:cursor-grabbing active:scale-90"
                >
...
export function MediaGrid({ items, onReorder = null, canReorder = false, renderOverlay = null }) {
