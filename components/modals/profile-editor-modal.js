...
export default function ProfileEditorModal({ close, data, header }) {
    ...
    return (
        <Container header={{ ...header }} close={close}>
            ...
            >
                <div className="grid gap-5 md:grid-cols-2 p-2">
                    <div className="space-y-2">
                        <label className="ml-1 text-[10px] font-bold tracking-[0.15em] text-white/40 uppercase">Display Name</label>
                        <Input
                    ...
                    <div className="space-y-2">
                        <label className="ml-1 text-[10px] font-bold tracking-[0.15em] text-white/40 uppercase">Username</label>
                        <Input
                            value={form.username}
                    ...
                    <div className="space-y-2">
                        <label className="ml-1 text-[10px] font-bold tracking-[0.15em] text-white/40 uppercase">Avatar URL</label>
                        <Input
                    ...
                    <div className="space-y-2">
                        <label className="ml-1 text-[10px] font-bold tracking-[0.15em] text-white/40 uppercase">Banner URL</label>
                        <Input
                ...
                <div className="flex justify-end gap-4 w-full pt-1">
                    <Button
                        type="button"
                        onClick={close}
                        className="center h-11 flex-auto rounded-[20px] cursor-pointer border border-white/10 bg-white/5 px-6 text-[10px] font-bold tracking-[0.2em] text-white/60 uppercase transition hover:bg-white/10 hover:text-white active:scale-95"
                    >
                        Cancel
                    </Button>
                    <Button
                        type="submit"
                        disabled={isSaving}
                        className="center h-11 flex-auto rounded-[20px] cursor-pointer bg-white px-8 text-[10px] font-bold tracking-[0.2em] text-black uppercase transition-all hover:bg-white/90 disabled:opacity-50 active:scale-95"
                    >
