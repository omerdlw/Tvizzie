            ...
            >
                <div className="space-y-5 p-2">
                    <div className="space-y-2">
                        <label className="ml-1 text-[10px] font-bold tracking-[0.15em] text-white/40 uppercase">List Title</label>
                        <Input
                            value={form.title}
                    ...
                    <div className="space-y-2">
                        <label className="ml-1 text-[10px] font-bold tracking-[0.15em] text-white/40 uppercase">Cover Image URL</label>
                        <Input
                            value={form.coverUrl}
                    ...
                    <div className="space-y-2">
                        <label className="ml-1 text-[10px] font-bold tracking-[0.15em] text-white/40 uppercase">Description</label>
                        <Textarea
                ...
                <div className="flex justify-end gap-3 pt-4">
                    ...
                    <Button
                        type="submit"
                        disabled={isSaving}
                        className="flex h-11 items-center rounded-[20px] bg-white px-8 text-[10px] font-bold tracking-[0.2em] text-black uppercase transition-all hover:bg-white/90 disabled:opacity-50 active:scale-95"
                    >
                        {isSaving
                            ? isEditing
                                ? 'Updating...'
