import { isPersonMediaType, isTvMediaType } from '@/domains/media/utils';

import { createSearchFallbackQueries } from './search/fallback-queries';
import {
  buildMovieAuthorityFallbackItems,
  rankResolvedMovieSearchItems,
} from './search/movie-ranking';
import {
  buildPersonAuthorityFallbackItems,
  rankResolvedPersonSearchItems,
} from './search/person-ranking';
import {
  dedupeSearchItems,
