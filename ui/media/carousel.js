    ...
    <div className="group/carousel relative -mx-1">
      ...
      {scrollState.canScrollLeft && (
        <motion.button
          ...
          className={cn(
            'center absolute top-1/2 left-2 z-10 size-6 -translate-y-1/2 cursor-pointer rounded border-[0.5px] border-white/10 bg-black text-white/70 transition duration-[200ms] hover:bg-black hover:text-white md:left-[-16px] md:size-8'
          )}
        >
      ...
      {scrollState.canScrollRight && (
        <motion.button
          ...
          transition={controlTransition}
          className={cn(
            'center absolute top-1/2 right-2 z-10 size-6 -translate-y-1/2 cursor-pointer rounded border-[0.5px] border-white/10 bg-black text-white/70 transition duration-[200ms] hover:bg-black hover:text-white md:right-[-16px] md:size-8'
          )}
        >
