...
const Button = forwardRef(({
  ...
  if (semanticIconVariantClasses) {
    return <button ref={ref} type={type} onClick={onClick} disabled={disabled} className={cn(baseClasses, semanticIconVariantClasses, 'size-9', classes.root)} {...props}>
          {children}
        </button>;
  }
  if (semanticVariantClasses) {
    return <button ref={ref} type={type} onClick={onClick} disabled={disabled} className={cn(baseClasses, semanticVariantClasses, 'h-9 gap-2 px-4 text-[10px] font-bold tracking-widest uppercase', classes.root)} {...props}>
          {children}
        </button>;
  }
  if (variant === 'toggle') {
    ...
    return <Toggle.Root ref={ref} pressed={isActive} onPressedChange={handleToggleChange} disabled={disabled} className={cn(classes.root, classes.default, isActive && classes.toggle)} {...props}>
          {children}
        </Toggle.Root>;
  }
  return <button ref={ref} type={type} onClick={onClick} disabled={disabled} className={cn(classes.root, classes.default)} {...props}>
        {children}
      </button>;
});
