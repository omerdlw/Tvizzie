...
function CrosshairLines({ className = '', side = 'left' }) {
  ...
  return (
    <>
      <span
        aria-hidden="true"
        className={cn(
          'pointer-events-none absolute top-0 h-[11px] w-px -translate-y-[5px] bg-white/15',
      ...
      <span
        aria-hidden="true"
        className={cn(
          'pointer-events-none absolute top-0 h-px w-[11px] bg-white/15',
