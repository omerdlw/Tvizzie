...
const NAV_EXIT_EASE = [0.32, 0, 0.67, 0];
...
const NAV_EXIT_TRANSITION_POSITIONAL = Object.freeze({
  opacity: { type: 'tween', duration: 0.16, ease: NAV_EXIT_EASE },
  filter: { type: 'tween', duration: 0.14, ease: NAV_EXIT_EASE },
  y: { type: 'tween', duration: 0.22, ease: NAV_EXIT_EASE },
  scale: { type: 'tween', duration: 0.22, ease: NAV_EXIT_EASE },
  x: { type: 'tween', duration: 0.22, ease: NAV_EXIT_EASE },
});
...
export const NAV_INLINE_SURFACE_PANEL_MOTION = Object.freeze({
  ...
  exit: {
    ...
    transition: Object.freeze({
      ...
      opacity: { duration: 0.14, ease: NAV_EXIT_EASE },
      clipPath: { duration: 0.2, ease: NAV_EXIT_EASE },
