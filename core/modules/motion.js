const NAV_CARD_SPRINGS = Object.freeze([
  Object.freeze({ type: 'spring', stiffness: 210, damping: 38, mass: 0.98 }),
  Object.freeze({ type: 'spring', stiffness: 190, damping: 36, mass: 1 }),
  Object.freeze({ type: 'spring', stiffness: 170, damping: 34, mass: 1.02 }),
]);
...
const NAV_EXIT_EASE = [0.16, 1, 0.3, 1];
...
const NAV_EXIT_TRANSITION_POSITIONAL = Object.freeze({
  opacity: { type: 'tween', duration: 0.24, ease: NAV_EXIT_EASE },
  filter: { type: 'tween', duration: 0.24, ease: NAV_EXIT_EASE },
  y: NAV_SURFACE_SPRING,
  scale: NAV_SURFACE_SPRING,
  x: NAV_SURFACE_SPRING,
});
...
export const NAV_CARD_EXIT = Object.freeze({
  ...
  scale: 0.96,
  y: 6,
  transition: NAV_EXIT_TRANSITION_POSITIONAL,
});
...
export const NAV_VIDEO_ICON_MOTION = Object.freeze({
  ...
  exit: { opacity: 0, scale: 0.84, transition: { duration: 0.16, ease: NAV_EXIT_EASE } },
...
export const NAV_ACTION_PANEL_MOTION = Object.freeze({
  initial: { opacity: 0, height: 0, y: 10, scale: 0.9, filter: 'blur(8px)' },
  ...
  exit: {
    ...
    transition: Object.freeze({
      ...NAV_EXIT_TRANSITION_POSITIONAL,
      height: { duration: 0.22, ease: NAV_EXIT_EASE },
    }),
  },
...
export const NAV_SURFACE_MOTION = Object.freeze({
  initial: { opacity: 0, scale: 0.975, filter: 'blur(8px)' },
...
export const NAV_INLINE_SURFACE_PANEL_MOTION = Object.freeze({
  ...
  exit: {
    ...
    filter: 'blur(8px)',
    transition: Object.freeze({
      height: { duration: 0.26, ease: NAV_EXIT_EASE },
      opacity: { duration: 0.2, ease: NAV_EXIT_EASE },
      clipPath: { duration: 0.26, ease: NAV_EXIT_EASE },
      filter: { duration: 0.2, ease: NAV_EXIT_EASE },
    }),
  },
  transition: Object.freeze({
...
export const NAV_DESCRIPTION_MOTION = Object.freeze({
  ...
  exit: {
    ...
    filter: 'blur(2px)',
    transition: Object.freeze({
      opacity: { duration: 0.16, ease: NAV_EXIT_EASE },
      y: { duration: 0.20, ease: NAV_EXIT_EASE },
      filter: { duration: 0.14, ease: NAV_EXIT_EASE },
    }),
  },
  transition: NAV_CONTENT_TRANSITION,
});
...
export const NAV_SEARCH_PANEL_MOTION = Object.freeze({
  ...
  exit: {
    ...
    transition: {
      ...NAV_EXIT_TRANSITION_POSITIONAL,
      height: { type: 'tween', duration: 0.2, ease: NAV_EXIT_EASE },
    },
  },
...
export const NAV_SEARCH_FADE_MOTION = Object.freeze({
  initial: { opacity: 0 },
  animate: { opacity: 1 },
  exit: { opacity: 0, transition: { type: 'tween', duration: 0.16, ease: NAV_EXIT_EASE } },
  transition: NAV_SEARCH_REVEAL_TRANSITION,
});
...
export function getNavActionItemMotion(index = 0) {
  const delay = getNavStaggerDelay(index);
  return {
    ...NAV_ACTION_ITEM_MOTION,
    exit: {
      ...NAV_ACTION_ITEM_MOTION.exit,
      transition: NAV_EXIT_TRANSITION_POSITIONAL,
    },
    transition: { ...NAV_ACTION_SPRING, delay },
  };
}
