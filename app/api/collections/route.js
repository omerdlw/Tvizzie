...
const PAGINATED_RESOURCES = new Set(['liked-lists', 'likes', 'list-items', 'lists', 'watchlist', 'watched']);
...
export async function GET(request) {
  try {
    ...
    const shouldPaginate = PAGINATED_RESOURCES.has(resource) && Boolean(normalizedCursor || normalizedLimit);
