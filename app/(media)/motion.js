...
const STAGES = Object.freeze({
  ...
  'items.actions': Object.freeze({ at: 1.34, duration: 0.68, y: 10, stagger: 0.11, lateDelay: 0.12 }),
  ...
  'items.seasons': Object.freeze({ at: 3.46, duration: 0.8, y: 16, scale: 0.975, stagger: 0.08, lateDelay: 0.12 }),
  'items.gallery': Object.freeze({ at: 4.12, duration: 0.84, y: 18, scale: 0.97, stagger: 0.085, lateDelay: 0.12 }),
  'items.images': Object.freeze({ at: 4.76, duration: 0.82, y: 18, scale: 0.97, stagger: 0.08, lateDelay: 0.12 }),
  'items.videos': Object.freeze({ at: 5.42, duration: 0.84, y: 18, scale: 0.975, stagger: 0.08, lateDelay: 0.12 }),
  'items.discovery': Object.freeze({ at: 5.5, duration: 0.84, y: 18, scale: 0.97, stagger: 0.085, lateDelay: 0.12 }),
  ...
  'person.sections.filmography': Object.freeze({ at: 2.76, duration: 1.06, y: 22, lateDelay: 0.22 }),
  'person.items.gallery': Object.freeze({ at: 2.42, duration: 0.8, y: 16, scale: 0.97, stagger: 0.09, lateDelay: 0.12 }),
  'person.items.filmography': Object.freeze({ at: 3.14, duration: 0.82, y: 16, scale: 0.97, stagger: 0.075, lateDelay: 0.12 }),
  'person.sections.timeline': Object.freeze({ at: 0.28, duration: 1.04, y: 20, lateDelay: 0.18 }),
  'person.timeline.year': Object.freeze({ at: 0.64, duration: 0.72, y: 10, stagger: 0.11, lateDelay: 0.12 }),
  'person.timeline.item': Object.freeze({ at: 0.82, duration: 0.8, y: 14, scale: 0.98, stagger: 0.065, lateDelay: 0.1 }),
  'person.sections.awards': Object.freeze({ at: 0.26, duration: 1.04, y: 20, lateDelay: 0.18 }),
  'person.awards.stat': Object.freeze({ at: 0.52, duration: 0.78, y: 14, scale: 0.97, stagger: 0.1, lateDelay: 0.12 }),
  'person.awards.filters': Object.freeze({ at: 1.12, duration: 0.68, y: 10, stagger: 0.06, lateDelay: 0.12 }),
  'person.awards.item': Object.freeze({ at: 1.5, duration: 0.82, y: 16, scale: 0.98, stagger: 0.075, lateDelay: 0.12 }),
});
...
export const MEDIA_ROUTE_INTERACTIONS = Object.freeze({
  card: Object.freeze({
    whileHover: Object.freeze({ scale: 1.018, transition: { duration: 0.34, ease: EASINGS.ACCENT } }),
    whileTap: Object.freeze({ scale: 0.985, transition: { duration: 0.18, ease: EASINGS.ACCENT } }),
  }),
  control: Object.freeze({
    whileHover: Object.freeze({ scale: 1.025, transition: { duration: 0.28, ease: EASINGS.ACCENT } }),
...
export function MediaRouteReveal({
  ...
  return (
    <motion.div
      ...
      initial="hidden"
      animate="visible"
      {...(interactive ? MEDIA_ROUTE_INTERACTIONS[interaction] || MEDIA_ROUTE_INTERACTIONS.card : {})}
      variants={{
        hidden,
        visible: {
          ...visible,
