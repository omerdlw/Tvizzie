import { cleanString, isValidHttpUrl, normalizeEmail, normalizeValue } from './normalize.ts';
...
export function normalizeProfileResponse(
  ...
  return {
    ...
    favoriteShowcase: Array.isArray(profile.favorite_showcase) ? profile.favorite_showcase : [],
